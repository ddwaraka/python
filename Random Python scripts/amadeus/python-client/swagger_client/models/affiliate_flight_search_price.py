...
class AffiliateFlightSearchPrice(object):
    ...
    def fees(self):
        """
        Gets the fees of this AffiliateFlightSearchPrice.
        The fees that apply in addition to the total price of this fare

        :return: The fees of this AffiliateFlightSearchPrice.
        :rtype: Fees
        """
        return self._fees
    ...
    def fees(self, fees):
        """
        Sets the fees of this AffiliateFlightSearchPrice.
        The fees that apply in addition to the total price of this fare

        :param fees: The fees of this AffiliateFlightSearchPrice.
        :type: Fees
        """
        self._fees = fees
